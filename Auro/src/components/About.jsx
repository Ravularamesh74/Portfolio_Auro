...
const About = () => {
  return (
    <>
      ...
      >
        I am a dedicated Full Stack Developer passionate about building scalable web applications and solving real-world problems using modern technologies. With strong expertise across both frontend and backend development, I create clean, efficient, and user-focused digital solutions. I am always eager to learn new tools, improve my skills, and contribute to impactful projects.
      </motion.p>
      <button
        ...
        onClick={() => {
          // Open resume from public assets. Place your resume at `public/assets/resume.pdf`.
